            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex flex-col items-center text-center">
                    ...
                    <div className="flex gap-6 mb-10">
                        ...
                        {/* Email */}
                        <a href="mailto:yourweddingemail@domain.com" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:text-gold hover:border-gold hover:bg-gold/5 transition-all duration-300 transform hover:-translate-y-1" aria-label="Email">
